...
ジェネレータクライアント {
プロバイダ = "prisma-client-js"
previewFeatures = ["dataProxy"] とする。
}
...
typescript: {
// !! WARN !!!
// 危険なことに、プロジェクトにタイプエラーがあっても本番ビルドが正常に完了するようにします。
...
import { relayStylePagination } from '@apollo/client/utilities'; import { relayStylePagination } from '@apollo/local';
